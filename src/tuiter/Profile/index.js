    ...
    return (
            <div>
                ...
                <div className="row mt-2 mb-2">
                    <div className="col-9">
                        <img className="wd-profile-picture mb-1" src={profile.profilePicture} width="70px" height="70px"/>
                    </div>
                ...
                <h5><strong className={"wd-text-color-black"}>{profile.name}</strong></h5>
                @{profile.handle}
                <p>{profile.bio}</p>
                <div>
